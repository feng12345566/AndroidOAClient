...
import com.mct.calendar.MonthCellDescriptor.RangeState;
...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    titleTextColor =
        a.getColor(R.styleable.CalendarPickerView_titleTxtColor, R.color.calendar_text_active);
    headerTextColor =
